...
const spPose& spBezierCurve::GetPose() { return pose_; }
...
const spColor& spBezierCurve::GetColor() { return color_; }
...
void spBezierCurve::SetHermiteControlPoints(const spHermiteCtrlPoints& pts) {
...
const spBezierCtrlPoints& spBezierCurve::GetBezierControlPoints() {
  return ctrl_pts_;
}
