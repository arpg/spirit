...
//  log.ReplaceWithSimData();
  ...
  for(int ii0=0; ii0<resolution; ii0++){
  for(int ii1=0; ii1<resolution; ii1++){
  for(int ii2=0; ii2<resolution; ii2++){
  for(int ii3=0; ii3<resolution; ii3++){
  for(int ii4=0; ii4<resolution; ii4++){
