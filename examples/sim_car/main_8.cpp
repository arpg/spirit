...
double V2(double th, double x, double y, double v, double p){
  //path following:
  return 0.225862183414*p + 1.72997759912*th*th + 3.47140424601*x*x + 2.39357820236*y*y + 1.74481692509*v*v - 1.4236608542*th*x - 0.487569114075*th*y + 1.04979531183*th*v - 0.991801818853*x*y + 0.938702983825*v*x + 0.257519449607*v*y;
}

double V2_pure(double th, double x, double y, double v){
  return 1.72997759912*th*th + 3.47140424601*x*x + 2.39357820236*y*y + 1.74481692509*v*v - 1.4236608542*th*x - 0.487569114075*th*y + 1.04979531183*th*v - 0.991801818853*x*y + 0.938702983825*v*x + 0.257519449607*v*y;
}
...
double dV2(double u_1, double u_2, double u_3, double th, double x, double y, double v, double p){
  ...
  double r = (2*1.72997759912*th - 1.4236608542*x - 0.487569114075*y + 1.04979531183*v)*(-2.9380*v_t*u_2 - dth_r*(1+u_3)) + 
    (2*3.47140424601*x - 1.4236608542*th - 0.991801818853*y + 0.938702983825*v)*(dth_r*(1+u_3)*y + v_t*-sin_th) + 
    (2*2.39357820236*y - 0.487569114075*th - 0.991801818853*x + 0.257519449607*v)*(dth_r*(1+u_3)*(-x) + v_t*cos_th - v_r*(1+u_3)) + 
    (2*1.74481692509*v + 1.04979531183*th + 0.938702983825*x + 0.257519449607*y)*(u_1);
  double boundary = 1;
  double L = V2(th, x, y, v, p);
  if( L > boundary )
    r += 0.225862183414*(1+u_3);
  return r;
}
...
Input K2(double th_t, double x_t, double y_t, double v_t, double p_t, int seg_prev, double u_1_prev, double u_2_prev, double u_3_prev){
  ...
  double b_1 = (2*1.74481692509*v + 1.04979531183*th + 0.938702983825*x + 0.257519449607*y);
  double b_2 = (2*1.72997759912*th - 1.4236608542*x - 0.487569114075*y + 1.04979531183*v)*(-2.9380*(v_t));
  double b_3 = (2*1.72997759912*th - 1.4236608542*x - 0.487569114075*y + 1.04979531183*v)*(-2.9380*v_t*0 - dth_r) + 
    (2*3.47140424601*x - 1.4236608542*th - 0.991801818853*y + 0.938702983825*v)*(dth_r*y) + 
    (2*2.39357820236*y - 0.487569114075*th - 0.991801818853*x + 0.257519449607*v)*(dth_r*(-x) - v_r) + 
    (2*1.74481692509*v + 1.04979531183*th + 0.938702983825*x + 0.257519449607*y)*(0);
  if (L > boundary){
    b_3 += 0.225862183414;
  }
  double a = (2*1.72997759912*th - 1.4236608542*x - 0.487569114075*y + 1.04979531183*v)*(-2.9380*v_t*0 - dth_r*(1+0)) +
    (2*3.47140424601*x - 1.4236608542*th - 0.991801818853*y + 0.938702983825*v)*(dth_r*(1+0)*y + v_t*-sin_th) +
    (2*2.39357820236*y - 0.487569114075*th - 0.991801818853*x + 0.257519449607*v)*(dth_r*(1+0)*(-x) + v_t*cos_th - v_r*(1+0)) +
    (2*1.74481692509*v + 1.04979531183*th + 0.938702983825*x + 0.257519449607*y)*(0);
  if (L > boundary){
    a += 0.225862183414;
  }
