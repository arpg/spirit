...
Eigen::ArrayXd CarODE2(Eigen::VectorXd y_t) {
  ...
  double TF_c23r = std::cos(sigma-theta);
  double TF_c24r = -std::sin(sigma+theta);
...
Eigen::ArrayXd CarODE1(Eigen::VectorXd y_t) {
  ...
  double TireLon2TFp2f = TireLon2TFr * TireLon2Ipf;
  double TireLon3TFp2f = TireLon3TFr * TireLon3Ipf;
  double ZeroJunctionp1v = ((TireLon3Ipf + TireLon2Ipf) + TireLon1Ipf) + TireLon0Ipf;
  double MGYp1e = Gainoutput * Iypf;
  double MGYp2e = Gainoutput * Ixpf;
  ...
  double ZeroJunction6p1v = Ixpf + TF_c25p1f;
  double ZeroJunction7p1v = Ixpf + TF_c26p1f;
  ...
  double Ixpe = (((((TireLat2Rpe + TireLat1Rpe) + TF_c17p2e) + TF_c14p2e) + TF_c13p2e) + TF_c10p2e) - MGYp1e;
  double Iype = (((((MGYp2e + TireLon2Rpe) + TireLon1Rpe) + TF_c07p2e) + TF_c04p2e) + TF_c03p2e) + TF_c00p2e;
...
Eigen::ArrayXd CarODE0(Eigen::VectorXd y_t) {
  ...
  double TireLon3Ipe = Sepe - TireLon3TFp1e;
  double Jzpe = ((((((TF_c27p2e + TF_c26p2e) + TF_c25p2e) + TF_c24p2e) + TF_c23p2e) + TF_c22p2e) + TF_c21p2e) + TF_c20p2e;
  double Ixpe = (((TireLat2Rpe + TireLat1Rpe) + TF_c17p2e) + TF_c14p2e) - MGYp1e;
  double Iype = (((MGYp2e + TireLon2Rpe) + TireLon1Rpe) + TF_c03p2e) + TF_c00p2e;
